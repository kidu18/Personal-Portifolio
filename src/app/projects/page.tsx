...
import { ExternalLink, ArrowRight, Github, Code2, Sparkles } from "lucide-react";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatePresence>
              {projects.map((project, i) => (
                ...
                >
                  <Card className="bg-zinc-900/40 border-zinc-800/50 backdrop-blur-sm group hover:border-emerald-500/30 transition-all duration-500 h-full flex flex-col overflow-hidden hover:shadow-2xl hover:shadow-emerald-500/10">
                    <div className="relative aspect-video w-full overflow-hidden bg-zinc-900 border-b border-zinc-800/50">
                      ...
                      >
                        <Button size="icon" className="rounded-full bg-emerald-500 hover:bg-emerald-400 text-black shadow-lg">
                    ...
                    <CardHeader className="space-y-3 pb-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.tags?.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="px-2 py-1 rounded-md bg-emerald-500/5 text-emerald-400/80 border border-emerald-500/10 text-xs font-medium"
                          >
                            {tag}
                          </span>
                        ))}
                    ...
                    <CardContent className="flex-1 space-y-4">
                      ...
                      {project.features && project.features.length > 0 && (
                        <div className="pt-2 border-t border-zinc-800/50">
                          <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">Key Features</p>
                    ...
                    <CardFooter className="pt-2 mt-auto">
                      ...
                      >
                        ...
                        >
                          <span className="text-zinc-400 group-hover/btn:text-emerald-400 transition-colors">View Live Project</span>
